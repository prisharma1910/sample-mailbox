...
class EmailList extends Component {
  render() {
    ...
    return (<tr>
      ...
      <td onClick={this.props.updateStatus} title="from"><span className={classForText}> {from} </span></td>
      <td onClick={this.props.updateStatus} title="subject"><span className={classForText}> {subject} </span></td>
